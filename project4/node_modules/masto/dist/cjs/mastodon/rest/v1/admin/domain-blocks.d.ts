...
export interface DomainBlocks$SelectResource {
     ...
     */
    update(params?: UpdateDomainBlockParams, meta?: HttpMetaParams<"json">): Promise<Admin.DomainBlock>;
    /**
...
export interface DomainBlocksResource {
     ...
     */
    list(params?: ListDomainBlocksParams, meta?: HttpMetaParams): Paginator<Admin.DomainBlock[], ListDomainBlocksParams>;
    /**
     ...
     */
    create(params: CreateDomainBlockParams, meta?: HttpMetaParams<"json">): Promise<Admin.DomainBlock>;
}
