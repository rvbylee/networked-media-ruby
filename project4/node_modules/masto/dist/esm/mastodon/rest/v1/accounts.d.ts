...
import { type Account, type AccountCredentials, type AccountField, type AccountSource, type FamiliarFollowers, type FeaturedTag, type IdentityProof, type List, type Relationship, type Status, type Token } from "../../entities/v1/index.js";
...
export interface Accounts$SelectFollowersResource {
     ...
     */
    list(params?: DefaultPaginationParams, meta?: HttpMetaParams): Paginator<Account[], DefaultPaginationParams>;
}
...
export interface Accounts$SelectEndorsementsResource {
    list(params?: DefaultPaginationParams): Paginator<Account[], DefaultPaginationParams>;
}
...
export interface AccountsSearchResource {
     ...
     * @see https://docs.joinmastodon.org/methods/accounts/
     */
    list(params?: SearchAccountsParams, meta?: HttpMetaParams): Paginator<Account[], SearchAccountsParams>;
}
